// Initialize Firebase
        ...
        var config = {
          apiKey: "AIzaSyC2CKw-GYjQvogL0uc7DQn8xseMS6B1JS8",
          authDomain: "rockpaperscissors-1fa00.firebaseapp.com",
          databaseURL: "https://rockpaperscissors-1fa00.firebaseio.com",
          projectId: "rockpaperscissors-1fa00",
          storageBucket: "rockpaperscissors-1fa00.appspot.com",
          messagingSenderId: "842638403903"
        };
...
$("#playerInfo").html("<form><input id=playerName type=text placeholder='Enter Name'><input id=enterPlayer type=submit value=Start></form>");
...
$("#enterPlayer").on("click", function(event) {
	...
	if (regex.test(player)) {
		...
		// if there is no player 2
			...
			// sets local variable of player number, to know which page to display choices on and who is chatting
            playerNum = 2;
